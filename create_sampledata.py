...
Original file is located at
    https://colab.research.google.com/drive/1csKKswa0syH28CloIs52dhfm-rKvLGtT
"""
...
# Konfiguration, die mit der Web-App übereinstimmt
DEFAULT_EVENTS_JSON = [
...
def get_event_labels(event_config):
    """Extrahiert die korrekten Label-Properties aus einem Event-Konfigurationsobjekt."""
    return {
...
def generate_random_data():
    """Erzeugt 180 Tage an zufälligen Gesundheitsmetriken."""
    metrics = []
    ...
    for i in range(179, -1, -1):
        ...
        if 'back_exercises' in event_config and day_of_week in [0, 1, 3, 4]: # Mo, Di, Do, Fr
        ...
        if pain_chance < 0.25: # 3x Stufe 2
            for p in range(3):
        ...
        elif pain_chance < 0.5: # 1x Stufe 1
        ...
        elif pain_chance < 1: # 2x Stufe 1
            for p in range(2):
                part = ALL_BODY_PARTS[p]
                metrics.append({'metric': f"pain_{part['id']}_level", 'timestamp': set_timestamp(14, 0), 'labels': {'body_part': part['id'], 'name': part['name']}, 'value': 1})

    # Sortieren der Metriken nach Zeitstempel, wie es die App erwartet
    ...
    return {
        ...
        "settings": {
            "reminderTime": "20:00",
            # Alle generierten Daten sind "committed"
...
if __name__ == "__main__":
    ...
    print(f"Zufallsdaten wurden erfolgreich in '{file_name}' gespeichert.")
